		...
		for (int col = (obj_col < 0 ? 0 : obj_col); col < ((obj_col + 2) > GetLevelNumOfColumns() ? GetLevelNumOfColumns() : (obj_col + 2)); col++)
		{
			...
			if (tile != nullptr && tile->IsCollidable() && SDL_HasIntersection(obj_ptr->getHitBox(), tile->GetWorldRect()))
			{
				...
				{ // Collision from top.
					...
					if (dynamic_cast<Player*>(obj_ptr) != nullptr)
					{
						if (obj_ptr->getAnimState() == Player::FALL)
						{
							obj_ptr->setAnimState(Player::IDLE);
						}
					}					
					result = DOWN;
				}
...
void Level::LoadLevel(LevelId level_id)
{
	...
	case CHURCH:
		...
		level_raw_str += "BB......................F....L....B";
		level_raw_str += "BB&..GG#GGG=GG#GGG......#GGGGGGGG=@";
		level_raw_str += "BB..G----&--------G.....@---------&";
		level_raw_str += "BB..@-----@-------B.S...&---------@";
		level_raw_str += "BB@.CCCCCCCCCCCCCCC@#@..&CCCCCCCCCB";
		level_raw_str += "BB............B........&..........B";
		level_raw_str += "BB................................B";
		level_raw_str += "BB.@@...........@@&@&@............B";
		level_raw_str += "BB......E......@......B...........B";
		level_raw_str += "BBG....L..............B...........B";
		level_raw_str += "B--GGG#GGGG#G.........BGGG........B";
		level_raw_str += "B---&--------GGGG=GG..B--&L..S.F..B";
		level_raw_str += "B-----&--BCCCCCCCCCC..CCCCCCCCCCCCB";
		level_raw_str += "BB-------&P..........@B...........B";
		level_raw_str += "B--@---&-B........................B";
		level_raw_str += "B----@---@........................B";
		level_raw_str += "CCCCCCCCCC........F&&.............B";
		level_raw_str += "...............@@@#...............B";
		level_raw_str += "F..L..S......@....................B";
		level_raw_str += "G=GG#GGGG=@............E..........B";
		level_raw_str += "B---&-----B&.......L..S.S........BB";
		level_raw_str += "B----@------GGGGGGGGG#GGGGGGG=GGG@@";
